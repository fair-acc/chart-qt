##############################################
# From https://github.com/forderud/QtWasm/blob/master/source/wasm.cmake
##############################################
...
function(link_qt_static target)
    ...
    set(APPNAME ${target})
    configure_file("${Qt6_DIR}/../../../plugins/platforms/wasm_shell.html"
                   "${target}.html")
    configure_file("${Qt6_DIR}/../../../plugins/platforms/qtloader.js"
                   qtloader.js COPYONLY)
    configure_file("${Qt6_DIR}/../../../plugins/platforms/qtlogo.svg"
                   qtlogo.svg COPYONLY)
endfunction()
